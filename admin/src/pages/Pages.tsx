...
export default function Pages() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-500">Create standalone pages (e.g. <code>/about</code>, <code>/contact</code>). The <strong>about</strong> page is built-in at <code>/about</code>.</p>
      {pages.length === 0 ? (
        <p className="text-gray-400">No pages yet. Create the "about" page with slug <code>about</code> to populate /about.</p>
      ) : (
