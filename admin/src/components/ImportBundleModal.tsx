  ...
  async function handleImport() {
    ...
    try {
      ...
      const resp = await api.importBundle({
        ...
        steps: parsed.steps,
        elements,
        project_translations: parsed.project_translations,
        project_step_translations: parsed.project_step_translations,
        content_element_translations: parsed.content_element_translations,
        mode: effectiveMode,
